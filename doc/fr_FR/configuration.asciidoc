...
==== Equipements compatibles
  ...
  - Cube : commande statut avec pour valeur move, tap_twice, shake_air, alert, flip_90, flip180, free_fall et une commande rotate avec la valeur en degré du mouvement
